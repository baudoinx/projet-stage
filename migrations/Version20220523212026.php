...
final class Version20220523212026 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pfmp (id INT AUTO_INCREMENT NOT NULL, eleve_id INT NOT NULL, Admin_id INT DEFAULT NULL, entreprise_id INT NOT NULL, numero VARCHAR(255) NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, noter INT NOT NULL, INDEX IDX_8677ACC4A6CC7B2 (eleve_id), INDEX IDX_8677ACC4E455FCC0 (Admin_id), INDEX IDX_8677ACC4A4AEAFEA (entreprise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE pfmp ADD CONSTRAINT FK_8677ACC4E455FCC0 FOREIGN KEY (Admin_id) REFERENCES utilisateur (id)');
        ...
        $this->addSql('ALTER TABLE eleve ADD Admin_id INT NOT NULL, ADD formation_id INT NOT NULL, ADD tuteur VARCHAR(255) NOT NULL, ADD specialite VARCHAR(20) DEFAULT NULL');
        $this->addSql('ALTER TABLE eleve ADD CONSTRAINT FK_ECA105F7E455FCC0 FOREIGN KEY (Admin_id) REFERENCES utilisateur (id)');
        $this->addSql('ALTER TABLE eleve ADD CONSTRAINT FK_ECA105F75200282E FOREIGN KEY (formation_id) REFERENCES formation (id)');
        $this->addSql('CREATE INDEX IDX_ECA105F7E455FCC0 ON eleve (Admin_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE eleve DROP Admin_id, DROP formation_id, DROP tuteur, DROP specialite');
    }
}
